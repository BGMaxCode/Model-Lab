...
mlflow.set_experiment("Event_Registration_Logs")

print("Starting simulated tracking runs for Event_Registration_Logs...")

param1_name = "expected_attendees"
param1_choices = [50, 100, 500]
param2_name = "ticket_tiers"
param2_choices = [1, 2, 3]
