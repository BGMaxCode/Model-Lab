...
mlflow.set_experiment("Ticket_Management_Logs")

print("Starting simulated tracking runs for Ticket_Management_Logs...")

param1_name = "support_staff_online"
param1_choices = [2, 5, 10]
param2_name = "priority_queue_enabled"
param2_choices = [True, False]
